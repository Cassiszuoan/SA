      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="">學測報名</a></li>
            <li class="dropdown">
...
<div class="container-entire">
  <div class="row cell-title">
    <h1>學科能力測驗</h1>
          ...
          <p class="col-sm-10">國文 英文 數學 自然 社會</p>
        ...
        <div class="test-data">
          <div class="row test-data-content">
            ...
            <form class="form-horizontal" role="form">
              ...
              <a href="modify" class="btn btn-danger" role="button">修改</a>
             
              <a href="apply" class="btn btn-info" role="button">回到報考頁面</a>

              <a href="confirmapplyGSAT" class="btn btn-success" role="button">確認報考</a>
            </center>
            </form>
          </div>
        </div>
