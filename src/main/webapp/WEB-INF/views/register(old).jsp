  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="register"  method="post">
        ...
        <p></p>
        <label>姓名:</label>
        <input class="form-control" type="text" id="name" name="name"  value= "${name}" placeholder="姓名">
        <p></p>
      ...
      <%--   <div class="form-group">
        ...
        <p></p> --%>
         <label>聯絡電話:</label>     
        <input class="form-control" type="text" id="phone" name="phone" placeholder="聯絡電話" value="${phone}">
        <p></p>
        <label>地址:</label>
        <input class="form-control" type="text" id="address" name="address" placeholder="通訊地址" value="${address}">
        <p></p>
        <label>緊急聯絡人姓名:</label>
        <input class="form-control" type="text" id="EmergencyContact" name="EmergencyContact" placeholder="緊急連絡人姓名" value="${emercontact}">
        <p></p>
        <label>與緊急聯絡人之關係:</label>
        <input class="form-control" type="text" id="EmergencyContactRelationship" name="EmergencyContactRelationship" placeholder="與緊急連絡人之關係" value="${emerrela}">
        <p></p>
        <label>緊急聯絡人電話:</label>
        <input class="form-control" type="text" id="EmergencyContactMobile" name="EmergencyContactMobile" placeholder="緊急連絡人電話" value="${emermobile}">
        <p></p>
