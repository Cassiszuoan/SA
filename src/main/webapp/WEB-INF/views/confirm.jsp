      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="">確認資料</a></li>
            <li class="dropdown">
          ...
          <div class="row test-data-content">
            ...
            <form class="form-horizontal" role="form">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.name}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">身分證字號</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.ID}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">性別</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.gender}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">生日</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.birth}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">連絡電話</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.phone}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">通訊地址</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.address}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">緊急連絡人姓名</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.getEmergencyContact()}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">緊急連絡人關係</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.getEmergencyContactRelationship()}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">緊急連絡人電話</label>
                <div class="col-sm-8">
                  <p class="form-control-static">${examinee.getEmergencyContactMobile()}</p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">是否為低收入戶</label>
                <div class="col-sm-8">
                  <p class="form-control-static">否 很有錢</p>
                </div>
              </div>
              <hr>
              <center>
             
              <a href="doublecheck" class="btn btn-danger" role="button">重新填寫</a>
             
       

              <a href="ConfirmExaminee" class="btn btn-success" role="button">確認註冊</a>
            </center>
            </form>
          </div>
        </div>
