  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="login" method="post" role="form">
        ...
        <input type="text" name="username" class="form-control" placeholder="身分證字號" required autofocus>
        <label for="inputPassword" class="sr-only">密碼</label>
        <input type="password" name="password" class="form-control" placeholder="密碼" required>
        <center>
          <a class="push btn btn-lg btn-warning widthchg" role="button" href="enroll.jsp">填寫資料註冊</a>
